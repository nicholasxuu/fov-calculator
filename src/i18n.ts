    ...
    resources: {
      ...
      it: {
        translation: {
          ...
          export_canvas: "Esporta Immagine",
      ...
      de: {
        translation: {
          ...
          export_canvas: "Bild exportieren",
          share: "Link teilen",
      ...
      fr: {
        translation: {
          ...
          verticalFov: "FOV Vertical",
          horizontalFov: "FOV Horizontal",
          export_canvas: "Exporter l'image",
